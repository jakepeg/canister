  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "cyan-lg": "0 0 30px rgba(6, 182, 212, 0.4), 0 0 60px rgba(6, 182, 212, 0.2)",
        "amber-sm": "0 0 10px rgba(245, 158, 11, 0.2)",
        "amber-md": "0 0 20px rgba(245, 158, 11, 0.3), 0 0 40px rgba(245, 158, 11, 0.1)",
        "amber-lg": "0 0 30px rgba(245, 158, 11, 0.4), 0 0 60px rgba(245, 158, 11, 0.2)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },

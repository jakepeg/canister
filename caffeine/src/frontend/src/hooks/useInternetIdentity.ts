...
const DEFAULT_IDENTITY_PROVIDER = (() => {
  ...
  // Use the hosted Internet Identity on id.ai in all environments.
  // The `#authorize` hash is required so that II enters the authorization flow
  // instead of trying to route via a missing canister.
